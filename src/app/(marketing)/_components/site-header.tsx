      ...
      <div className="mx-auto flex h-14 items-center justify-between gap-4 px-12">
        ...
        <div className="flex flex-1 items-center justify-end gap-2 md:gap-3">
          ...
          <Dialog open={mobileOpen} onOpenChange={setMobileOpen}>
            ...
            <DialogContent className="top-4 right-4 left-auto max-h-[min(100dvh-2rem,32rem)] w-[min(100%-2rem,20rem)] translate-x-0 translate-y-0 overflow-y-auto sm:max-w-sm">
              <DialogHeader>
