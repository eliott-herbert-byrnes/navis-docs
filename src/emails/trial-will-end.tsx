...
export function TrialWillEndEmail({
  ...
  return (
    <EmailLayout
      preview={`Your Navis Docs trial for ${orgName} ends in ${daysRemaining} days — add a payment method to keep access`}
    ...
    >
      ...
      <Section className="mb-6">
        ...
        <Text className="text-base leading-relaxed text-gray-700 mb-4">
          ...
          {daysRemaining} days. Add a payment method now to keep full access
